...
This prompt provides everything an AI agent needs to create the SafeMode project from scratch, including architecture, features, styling, and implementation details.
